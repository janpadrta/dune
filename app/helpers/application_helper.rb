module ApplicationHelper
  ...
  def format_mena(castka, mena = '', des_cisla = true)
    return number_to_currency(castka, {unit: mena, locale: :cs, format: '%n %u'}) if des_cisla
    number_to_currency(castka, {unit: mena, locale: :cs, format: '%n %u'}).gsub!('.00', '')
  end
